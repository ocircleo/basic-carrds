...
const Card = ({ data }) => {
    ...
    return (
        <div className=" w-fit gap-5 px-8 py-6 relative rounded outline outline-indigo-200 outline-offset-2  border flex flex-col sm:flex-row items-center justify-center">
